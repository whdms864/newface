...
<div id="con_wrap">
	...
	<div id="con">
		<form method="post" action="<c:url value='/ader_update'/>">
		<div style="margin-top: 20px;background-color: rgb(239, 238, 238);width: 89%;height:50%;margin-left: 40px;padding: 10px;">
			<div style="margin-left: 67px;">
				...
				<div class="form-group has-warning" style="display: inline-block; ">
					<label class="control-label" for="inputWarning1">광고주No.</label>
					<br>
					<input type="text" name="ader_num" class="form-control" style="width:500px;" value="${vo.ader_num }">
				</div>
				...
				<div class="form-group has-warning" style="display: inline-block; ">
					...
					<br>
					<input type="text" name="hname" class="form-control" style="width:500px;" value="${vo.hname }">
				</div>
				
				<div class="form-group has-warning" style="display: inline-block; ">
					<label class="control-label" for="inputWarning1">대표명</label>
					<br>
					<input type="text" name="pname" class="form-control" style="width:500px;" value="${vo.pname }">
				</div>
				
				<div class="form-group has-warning" style="display: inline-block; ">
					<label class="control-label" for="inputWarning1">사업자번호</label>
					<br>
					<input type="text" name="snum" class="form-control" style="width:500px;" value="${vo.snum }">
				</div>
				
				<div class="form-group has-warning" style="display: inline-block; ">
					<label class="control-label" for="inputWarning1">담당자명</label>
					<br>
					<input type="text" name="dname" class="form-control" style="width:500px;" value="${vo.dname }">
				</div>
				
				<div class="form-group has-warning" style="display: inline-block; ">
					<label class="control-label" for="inputWarning1">전화번호</label>
					<br>
					<input type="text" name="phone" class="form-control" style="width:500px;" value="${vo.phone }">
				</div>
				
				<div class="form-group has-warning" style="display: inline-block; ">
					<label class="control-label" for="inputWarning1">등록날짜</label>
					<br>
					<input type="text" name="regdate" class="form-control" style="width:500px;" value="${vo.regdate }" readonly="readonly">
				</div>
			</div>
		</div>
		...
		<div style="position:absolute;top:610px;width: 98%;"align="center">
				...
				<input type="submit" value="수정" style="font-size: 16px; color: rgb(255, 255, 255); text-align: center; line-height: 2.4em; 
				border-radius: 4px; background-color: rgb(52, 152, 219);width:120px; height:40px;margin-top:10px;">
				<input type="submit" value="삭제" style="font-size: 16px; color: rgb(255, 255, 255); text-align: center; line-height: 2.4em; 
				border-radius: 4px; background-color: rgb(52, 152, 219);width:120px; height:40px;margin-top:10px;" onClick="location.href='/newface/ader_delete?ader_num=${ader_num}'">  
		</div>
		</form>
	</div>
</div>
