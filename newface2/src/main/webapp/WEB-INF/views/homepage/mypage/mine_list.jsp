	...
	<div id="con" align="center">
		  	...
		  	<tbody>
		  		...
		  		<c:forEach var="vo" items="${list}">
		  			<tr>
			  			...
			  			<td style="overflow: hidden;text-overflow: ellipsis;white-space: nowrap;max-width: 100px;"><a class="info"><input type="hidden" value="${vo.item_num }" class="item_num_val">${vo.iname}</a></td>
		...
		<div style="position:absolute;top:620px;width: 98%;"align="center">
			...
			<c:when test="${pu.startPageNum>5 }">
				<a href="<c:url value='/market/mine/list?pageNum=${pu.startPageNum-1 }'/>">
		...
		<c:forEach var="i" begin="${pu.startPageNum }" end="${pu.endPageNum }">
			<c:choose>
				<c:when test="${i==pu.pageNum }">
					<a href="<c:url value='/market/mine/list?pageNum=${i }'/>">
		...
		<c:choose>
			<c:when test="${pu.endPageNum<pu.totalPageCount}">
				<a href="<c:url value='/market/mine/list?pageNum=${pu.endPageNum+1 }'/>">
					<span class="btnnext">
							▷▷
					</span>
				</a>
